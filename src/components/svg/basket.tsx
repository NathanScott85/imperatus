    ...
    <>
        {type.includes('bag') && (
            <svg width={width} height={height} viewBox={viewbox} fill={fill}>
                ...
                />
                <path
                    d="M13 8V5C13 2.79086 11.2091 1 9 1V1C6.79086 1 5 2.79086 5 5L5 8"
                    stroke="#2B3F6C"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                />
        ...
        {type?.includes('full') && (
            <svg width="20" height="22" viewBox="0 0 20 22" fill={fill}>
                <path
                    d="M2.53715 9.47134C2.80212 7.48412 4.49726 6 6.50207 6H13.4979C15.5027 6 17.1979 7.48412 17.4628 9.47135L18.3962 
            16.4713C18.7159 18.8693 16.8504 21 14.4313 21H5.56873C3.14958 21 1.2841 18.8693 1.60382 
            16.4713L2.53715 9.47134Z"
                    stroke="#C79D0A"
                    strokeWidth="1.5"
                />
                <path
                    d="M7.5 14L9.5 16L13.5 12"
                    stroke="#C79D0A"
                    strokeWidth="1.5"
                    strokeLinecap="round"
        ...
        {type?.includes('Bag') && (
            <svg width="20" height="22" viewBox="0 0 20 22" fill={fill}>
                <path
                    d="M13.75 9.5V5C13.75 2.92893 12.0711 1.25 10 1.25C7.92893 1.25 6.25 2.92893 6.25 5V9.5M17.606 7.50723L18.8692 
