...
export const Icon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path
            ...
            strokeLinecap="round"
        />
        <circle cx="6" cy="20" r="2" stroke={props.stroke ? props.stroke : 'black'} strokeWidth="1.5" />
        <circle cx="17" cy="20" r="2" stroke={props.stroke ? props.stroke : 'black'} strokeWidth="1.5" />
        <path
            d="M8 20L15 20"
            stroke={props.stroke ? props.stroke : 'black'}
            strokeWidth="1.5"
